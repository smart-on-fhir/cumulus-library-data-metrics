...
class TermUseBuilder(MetricMixin, BaseTableBuilder):
    ...
    def prepare_queries(self, *args, **kwargs) -> None:
        ...
        self.queries = [
            self.make_table(src="AllergyIntolerance", field="code", system="http://loinc.org"),
            ...
            # self.make_table(src="MedicationAdministration", field="medicationCodeableConcept", system="http://www.nlm.nih.gov/research/umls/rxnorm"),
